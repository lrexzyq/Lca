...
local hitEffectDepBox = hitEffectsTab
...
local noAnimDepBox = viewportTab
...
local hitNotifDepBox = hitNotifTab
...
local hitNotifPosDepBox = hitNotifDepBox
...
local killSoundsDep = killSoundsTab
